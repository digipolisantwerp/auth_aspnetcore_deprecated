...
namespace Digipolis.Auth.UnitTests.Jwt
{
    public class JwtSigningKeyResolverTests
    {
        ...
        public void ThrowsExceptionWhenNoX5uHeaderPresent()
        {
            ...
            var resolver = new JwtSigningKeyResolver(Mock.Of<HttpClient>(), mockedCache.Object, Options.Create(_options));
            var token = "";
        ...
        public void X5uFromHeaderIsUsed()
        {
            ...
            var resolver = new JwtSigningKeyResolver(client, mockedCache.Object, Options.Create(_options));
